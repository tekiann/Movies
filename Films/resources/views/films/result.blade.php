            ...
            <div class="collapse navbar-collapse justify-content-end " id="collapsibleNavId">
                <form action="{{route('search_film')}}" class="form-inline my-2 my-lg-0" method="post">
                    ...
                    <ul class="navbar-nav mr-auto mt-2 mt-lg-0 ">
                        ...
                        <li class="nav-item mx-1">
                            <input type="text" class="form-control my-1 mr-2" name="ano" id="" aria-describedby="helpId" placeholder="Ano">
                        </li>
                        <li class="nav-item mx-1">
        ...
        <div class="container mt-2">
            <div class="row">
                ...
                <div class="media border p-3 row">
                    <img src="{{$search['Poster']}}" alt="John Doe" class="mr-3 thumbnail col-2" style="width:100px;">
                    <div class="media-body col-8">
                        <h4>{{$search['Title']}}({{$search['Year']}})
